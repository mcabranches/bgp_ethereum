...
R1 = net.addDocker('R1', ip="11.0.0.1/8", dimage="r1-quagga")
R2 = net.addDocker('R2', ip="12.0.0.1/8", dimage="r2-quagga")
R3 = net.addDocker('R3', ip="13.0.0.1/8", dimage="r3-quagga")
# Attacker node
R4 = net.addDocker('R4', ip="13.0.0.1/8", dimage="r4-quagga")

# add end host code here
WS = net.addDocker('WS', ip="13.0.1.1/8", dimage="ws-quagga")
AWS = net.addDocker('AWS', ip="13.0.1.1/8", dimage="ws-quagga")
C1 = net.addDocker('C1', ip="11.0.0.2/8", dimage="quaggabase")
...
net.addLink(R1,s1,params1={"ip":"11.0.0.1/8"})
net.addLink(R2,s2,params1={"ip":"12.0.0.1/8"})
net.addLink(R3,s3,params1={"ip":"13.0.0.1/8"})
net.addLink(R4,s4,params1={"ip":"13.0.0.1/8"})

# Link hosts to their AS switches
net.addLink(C1,s1,params1={"ip":"11.0.0.2/8"})
net.addLink(WS,s3,params1={"ip":"13.0.1.1/8"})
net.addLink(AWS,s4,params1={"ip":"13.0.1.1/8"})
...
AWS.cmd('route add default gw 13.0.0.1')
